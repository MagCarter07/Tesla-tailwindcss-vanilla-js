...
const updateTotalPrice = () => {
    //reset the current price to the base to the base price
...
const updatePaymentBreakdown = () => {
    ...
    // Calculate loan details (assuming a 60month loan and a 3% interest rate)
    ...
    const monthlyPayment = (loanAmount * 
        (monthlyInterestRate * 
            Math.pow(1 + monthlyInterestRate, loanTermMonths))) / (Math.pow(1 + monthlyInterestRate, loanTermMonths) - 1);
